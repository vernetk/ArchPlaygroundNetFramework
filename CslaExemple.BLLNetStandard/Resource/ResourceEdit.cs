...
using RFit.BusinessLibrary;
using RFit.BusinessLibrary.Rules;
using System;
...
namespace CslaExemple.BLLNetStandard
{
    ...
    public class ResourceEdit : CslaBaseTypes.BusinessBase<ResourceEdit>
    {
        ...
        {
            BusinessRules.AddRule(new ResourceNoDuplicateFirstNameAndLastNameRule(FirstNameProperty, LastNameProperty, IdProperty) { Priority = 3 });
